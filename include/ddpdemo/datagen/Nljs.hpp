 ...
 * namespace dunedaq::ddpdemo::datagen to be serialized via nlohmann::json.
 */
#ifndef DUNEDAQ_DDPDEMO_DATAGEN_NLJS_HPP
#define DUNEDAQ_DDPDEMO_DATAGEN_NLJS_HPP


#include "ddpdemo/datagen/Structs.hpp"
...
#endif // DUNEDAQ_DDPDEMO_DATAGEN_NLJS_HPP